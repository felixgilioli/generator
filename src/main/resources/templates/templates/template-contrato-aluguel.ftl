...
<div id="content">
    ...
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">1) O LOCADOR cede para locação residencial ao LOCATÁRIO,
        o imóvel situado <b>(ENDEREÇO DO IMÓVEL)</b>.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">2) A locação destina-se ao uso exclusivo como residência
        e domicilio do LOCATÁRIO.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">3) O prazo de locação é de <b>${tempoLocacao}</b>, iniciando-se
        em <b>${dataInicioLocacao}</b> e terminando em <b>${dataFimLocacao}</b>, limite de tempo em que o imóvel
        objeto do presente deverá ser restituído independentemente de qualquer
        notificação ou interpelação sob pena de caracterizar infração contratual.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">4) O aluguel mensal será de <b>R$ ${valorAluguel}</b> e deverá ser pago
        até a data de seu vencimento, todo dia <b>${diaPagamentoAluguel}</b> do mês seguinte ao vencido,
        no local do endereço do <b>LOCADOR</b> ou outro que o mesma venha a designar.</p>
    <p style="margin-left: 17pt; text-align: justify;">4.1) A impontualidade acarretará juros moratórios na
        ...
        corrigido.</p>
    <p style="margin-left: 17pt; text-align: justify;">4.2) O pagamento de qualquer dos aluguéis não implica
        ...
        respectivos recibos.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">5) O aluguel será reajustado anualmente pela variação do
        ...... (<b>ÍNDICE<i>, </i></b><i>exemplo: IGP-M, INPC-IBGE, etc</i>.).
        ...
        período.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">6) Havendo prorrogação tácita ou expressa do presente
        ...
        periodicidade.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">7) Nas cobranças judiciais e extrajudiciais de alugueis
        ...
        obrigações contratuais deixadas de quitar nas épocas certas.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">8) O imóvel da presente locação destina-se ao uso
        ...
        parte, sem a prévia e expressa autorização do LOCADOR.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">9) Além do aluguel são de responsabilidade do LOCATÁRIO
        ...
        os comprovantes de quitação juntamente com o pagamento do aluguel.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">10) O LOCATÁRIO declara neste ato tomar conhecimento da
        ...
        pena de rescisão contratual.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">11) Encerrada a locação a entrega das chaves só será processada
        ...
        de luz.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">12) Fica facultado ao LOCADOR ou ao seu representante
        legal vistoriar o imóvel sempre que julgar necessário.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">13) O LOCATÁRIO se obriga, sob pena de cometer infração
        ...
        previsto.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">14) O LOCATÁRIO assume o compromisso de solicitar ao
        LOCADOR uma vistoria 30 (trinta) dias antes de desocupar o imóvel para ser
        constatado o estado de conservação do mesmo.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">15) Quaisquer modificações no imóvel locadas só poderão
        ...
        cabendo direito de indenização, retenção, compensação ou reembolso.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">16) Se no curso da locação vier a ocorrer incêndio ou
        ...
        direito de indenização ou retenção do objeto do presente contrato.</p>
    <p style="text-align: justify; margin-left: 17pt; text-indent: -17pt;">17) O LOCATÁRIO
        ...
        mediante comunicação por e-mail, whatsapp ou outro formato eletrônico, afora as demais formas previstas em lei.</p>
    <p style="text-align: justify; margin-left: 17pt; text-indent: -17pt;">18) Fica convencionado
        ...
        comunicações previstas neste instrumento.</p>
    <p style="text-align: justify;">19) Se o LOCATÁRIO vier a usar da faculdade que lhe
        ...
        contrato já cumprido.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">20) Salvo declaração escrita do LOCADOR, quaisquer
        ...
        procedente para se furtar ao cumprimento do contrato.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">21) Permanecendo o LOCATÁRIO no imóvel após o prazo de
        ...
        a desocupação não se verificar na data convencionada.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">22) No caso do imóvel ser posto à venda, o LOCATÁRIO
        ...
        em horários previamente convencionados.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">23) O LOCATÁRIO declara, para todos os fins e efeitos de
        ...
        do imóvel.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">24) Assina também o presente contrato como FIADOR e
        ...
        ao imóvel e demais encargos decorrentes da locação, <b>${nomeFiador}, ${cpfFiador}, ${identidadeFiador}, ${enderecoFiador}</b>, consoante o artigo 818 do Novo Código Civil
        ...
        responsabilidade até a entrega das chaves, inclusive em caso de prorrogação.</p>
    <p style="margin-left: 17pt; text-align: justify; text-indent: -17pt;">25) Em caso de ausência,
        ...
        e despejo, se não o fizer nesses dias de mera tolerância.</p>
    <p style="text-align: justify; margin-left: 17pt; text-indent: -17pt;">26) Elegem as partes o foro do domicílio do LOCADOR, para
        dirimir quaisquer dúvidas oriundas do presente contrato, renunciando a qualquer
        outro por mais privilegiado que seja. </p>
    <p style="text-align: justify;">E por estarem LOCADOR e LOCATÁRIO de pleno
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="text-align: justify; border-collapse: collapse;">
        ...
        <tr>
            <td width="322" valign="top" style="width: 241.45pt; padding: 0cm 3.5pt;">
                <p style="text-align: justify;"><b>${nomeLocador}</b></p></td>
            <td width="322" valign="top" style="width: 241.45pt; padding: 0cm 3.5pt;">
                <p style="text-align: justify;"><b>${nomeLocatario}</b></p></td>
        </tr>
        <tr>
            <td width="322" valign="top" style="width: 241.45pt; padding: 0cm 3.5pt;">
                <p style="text-align: justify;">LOCADOR</p></td>
            <td width="322" valign="top" style="width: 241.45pt; padding: 0cm 3.5pt;">
                <p style="text-align: justify;">LOCATÁRIO</p></td>
        </tr>
        </tbody>
    </table>
    <p style="text-align: justify;"></p>
    ...
    <p style="text-align: justify;"></p>
    <table border="1" cellspacing="0" cellpadding="0" style="text-align: justify; border-collapse: collapse; border: none;">
        <tbody>
        <tr>
            <td width="322" valign="top" style="width: 241.45pt; border: none; padding: 0cm 3.5pt;">
                <p style="text-align: justify;"><b>${nomeTestemunha1} - ${identidadeTestemunha1}</b></p>
            </td>
            <td width="322" valign="top" style="width: 241.45pt; border: none; padding: 0cm 3.5pt;">
                <p style="text-align: justify;"><b>${nomeTestemunha2} - ${identidadeTestemunha2}</b></p>
            </td>
        </tr>
        </tbody>
    </table>
